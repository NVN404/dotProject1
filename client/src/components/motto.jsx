...
const Motto = () => {
  return (
    <div className="w-[90vw] h-[auto] md:h-screen mx-auto grid grid-cols-1 md:grid-cols-3 p-6 bg-white overflow-hidden mb-8">

      <div className="p-6 bg-[#D0E7F8] md:h-full h-[90dvh] text-[#3A3A3A] flex flex-col justify-between gap-2 space-around">
        ...
        <img src="./img1.png" className="h-[auto] mt-[20em]" />
      </div>
