...
// const Footer = () => {
//   return (
//     <div className="h-[45dvh]  bg-[#003cff] w-full flex flex-col justify-between">
...
//       <div className="h-[3em] bg-[#1E60AB] w-full absolute bottom-0 flex justify-between items-center">
